...
**Timestamp:** 2025-08-15T14:43:45.452Z
...
```json
{
  ...
  "data": {
    "metadata": {
      "title": "Guia Rápido: Dominando a Aplicação Web",
      "subtitle": "Um guia prático para explorar todas as funcionalidades da nossa aplicação web",
      "version": "1.0.0",
      "dateCreated": "15/08/2025",
      "targetAudience": "Usuários finais de todos os níveis de experiência",
      "estimatedReadTime": "15-30 minutos"
    },
    "introduction": {
  ...
  "timestamp": "2025-08-15T14:43:45.451Z"
}
```
