  ...
  private async handleCrawlAnalysis(task: TaskData): Promise<TaskResult> {
    ...
    try {
      ...
      for (const pageData of crawlResults) {
        this.log(`Analisando página: ${pageData.title}`);
...
- **Páginas Analisadas:** ${analysis.totalPages}
...
## 📊 Estatísticas Gerais
- **Total de Páginas Analisadas**: ${analysis.totalPages}
- **Total de Elementos Interativos**: ${analysis.totalElements}
- **Complexidade do Sistema**: ${analysis.technicalInsights.complexity.toUpperCase()}
